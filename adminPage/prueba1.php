	...
	<div class="modal_Adding_Bacground" id="modal_Adding">
		...
		<div class="modal_Adding_Container">
			...
			<div class="modal_Adding_Container_Buttons">
				...
				<button class="modal_Adding_Container_Button" onclick="addProductToOrder()">A�adir</button>
			</div>
		</div>
	</div>
</body>
...
<?php
	...
	*/
	...
	for($i = 0 ; $i < $numberOfRows ; $i++) {
		...
		echo  "<span >Descripci�n: ".$row['description']."</span><BR>";
...
<script>
	const veganFood = [
		...
		{ name: "Tofu", price: "1.30", description: "Nunca he sab�oh lo que es Hulio" },
	];
	const carnianFood = [
		{ name: "Vaca", price: "9.20", description: "Carne de animal con 4 patas y cuernos" },
		{ name: "Ciervo", price: "20.95", description: "Carne de animal con 4 patas y cuernos m�s largos" },
	];

	const foodTypesList = [
		{ type: "Vegano", productsList: veganFood },
		{ type: "Carn�voro", productsList: carnianFood }
	];
